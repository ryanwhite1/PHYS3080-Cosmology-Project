...
fig.savefig(dir_path+f'\\Part One Graphs\\Scalefactor-vs-LookbackTime for Our Universe.png', dpi=200, bbox_inches='tight', pad_inches = 0.01)
fig.savefig(dir_path+f'\\Part One Graphs\\Scalefactor-vs-LookbackTime for Our Universe.pdf', dpi=200, bbox_inches='tight', pad_inches = 0.01)
plt.close(fig)
...
fig.savefig(dir_path+f'\\Part One Graphs\\Scalefactor-vs-LookbackTime.png', dpi=200, bbox_inches='tight', pad_inches = 0.01)
fig.savefig(dir_path+f'\\Part One Graphs\\Scalefactor-vs-LookbackTime.pdf', dpi=200, bbox_inches='tight', pad_inches = 0.01)
plt.close(fig)
...
fig.savefig(dir_path+f'\\Part One Graphs\\Comoving Distance vs Redshift.png', dpi=200, bbox_inches='tight', pad_inches = 0.01)
fig.savefig(dir_path+f'\\Part One Graphs\\Comoving Distance vs Redshift.pdf', dpi=200, bbox_inches='tight', pad_inches = 0.01)
plt.close(fig)
...
ax.set_xlim(xmin=0); ax.set_ylim(ymin=0)
fig.savefig(dir_path+f'\\Part One Graphs\\Emission Distance vs Redshift.png', dpi=200, bbox_inches='tight', pad_inches = 0.01)
fig.savefig(dir_path+f'\\Part One Graphs\\Emission Distance vs Redshift.pdf', dpi=200, bbox_inches='tight', pad_inches = 0.01)
plt.close(fig)
...
ax.set_xlim(xmin=0)
fig.savefig(dir_path+f'\\Part One Graphs\\DL and DA vs Redshift.png', dpi=200, bbox_inches='tight', pad_inches = 0.01)
fig.savefig(dir_path+f'\\Part One Graphs\\DL and DA vs Redshift.pdf', dpi=200, bbox_inches='tight', pad_inches = 0.01)
plt.close(fig)
